    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="गाव अहवाल" pageTitle="होम"/>
                    <Row>
                        <Col lg={12}>
                            <Card>
                                  <CardHeader className="d-flex justify-content-between align-items-center">
                                                                   <h4 className="card-title mb-0">गाव अहवाल</h4>
                                                                   <Button
                                                                       color="success"
                                            ...
                                            <table className="table align-middle table-nowrap" id="customerTable">
                                                <thead className="table-light">
                                                    <tr>
                                                        ...
                                                        <th className="sort" data-sort="name">गावाचं नाव</th>
                                                        <th className="sort" data-sort="name">तालुका</th>
                                                ...
                                                <tbody className="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="name">Tathawade</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td className="id" style={{ display: "none" }}><Link to="#" className="fw-medium link-primary">#VZ2112</Link></td>
                                                        <td className="name">Aakurdi</td>
                                                        <td className="name">Haveli</td>
                                                        {/* <td className="email">kevindawson@velzon.com</td>
                                                        <td className="phone">213-741-4294</td> */}
                                                        <td className="status"><span className="badge bg-success-subtle text-success text-uppercase">Active</span></td>
                                                        <td>
