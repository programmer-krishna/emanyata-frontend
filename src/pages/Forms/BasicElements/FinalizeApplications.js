...
const ApplicationPage = () => {
  ...
  document.title = "Finalized Applications | ई मान्यता प्रणाली"
  ...
  const handleAction = (action, rowIndex) => {
    ...
    if (action === "view") {
      navigate("/अंतिम-मंजूर-अर्जाचे-विवरण", {
        state: {
          id: rowData[0],
          status: rowData[1],
      ...
      navigate("/अंतिम-मंजूर-अर्जाची-नोंद", {
        state: {
          id: rowData[0],
          schoolName: rowData[2],
  ...
  const handlePDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Finalized Applications", 14, 15);
  ...
  const tableData = [
    ...
    [2, "Application Finalized", "P A I H TECH ENGLISH SCHOOL KONDHWA KHURD PUNE 411048", "कोंढवा खुर्द पुणे 411048"],
    [3, "Application Finalized", "RAHUL INTERNATIONAL SCHOOL", "SERVEY NO 274/275/2A/2 HINJEWADI, MULSHI"],
    [
      4,
      "Application Finalized",
    ...
    [5, "Application Finalized", "Patil NATIONAL SCHOOL", "SERVEY NO 274/275/2A/2 HINJEWADI, MULSHI"],
    [
      6,
      "Application Finalized",
    ...
    [7, "Application Finalized", "The Orbis School Keshavnagar", "Survey No 66, Village Keshavnagar, Mundhwa, Pune"],
    [8, "Application Finalized", "VIBGYOR High School Balewadi", "Survey No. 29, Balewadi, Pune"],
    [
      9,
      "Application Finalized",
    ...
    [10, "Application Finalized", "Delhi Public School Pune", "Survey No. 43, Baner Road, Pune"],
    [11, "Application Finalized", "Symbiosis International School", "Lavale, Mulshi, Pune"],
    [12, "Application Finalized", "Podar International School", "Pimpri-Chinchwad, Pune"],
    [13, "Application Finalized", "Indira National School", "Tathawade, Pune"],
    [14, "Application Finalized", "Akshara International School", "Wakad, Pune"],
    [15, "Application Finalized", "Euro School", "Wakad, Pune"],
    [16, "Application Finalized", "Wisdom World School", "Hadapsar, Pune"],
    [17, "Application Finalized", "The Bishop's School", "Camp, Pune"],
  ]
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Finalized Applications" pageTitle="होम" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader className="d-flex justify-content-between align-items-center">
                  <h4 className="card-title mb-0">Finalized Applications</h4>
                </CardHeader>
                          ...
                          {currentItems.map((row, index) => {
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td>
                                  <span
                                    className={`badge ${row[1].includes("Finalized") ? "bg-success" : "bg-warning"}`}
                                  >
                                    {row[1]}
                                  </span>
                                </td>
